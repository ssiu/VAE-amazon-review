...
class VocabEntry(object):
    ...
    @staticmethod
    def from_corpus(corpus, size, freq_cutoff, save_path):
        ...
        json.dump(word_distribution, open(save_path, 'w'), indent=2)
...
class Vocab(object):
    ...
    @staticmethod
    def build(sents, vocab_size, freq_cutoff, save_path) -> 'Vocab':
        print('initialize source vocabulary ..')
        dct = VocabEntry.from_corpus(sents, vocab_size, freq_cutoff, save_path)
        return Vocab(dct)
